...
#ifndef SHW_IR_BUILDER_H
#define SHW_IR_BUILDER_H
...
class ShwIRBuilder: public AstVisitor {
...
private:
    static std::unordered_map<ProgramAST *, ShwIRBuilder *> ProgToIrBuilderMap;
...
public:
    static ShwIRBuilder *getOrCreateIrBuilderByProg(ProgramAST *prog);
